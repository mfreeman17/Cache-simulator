...
"""
    #462.libquantum.gz; 464.h264ref.gz; 403.gcc.gz; 445.gobmk.gz
    mo_files=[["462.libquantum.gz"], ["464.h264ref.gz"], ["403.gcc.gz"], ["445.gobmk.gz"]]

    cacheSize = 16384
    wayss = [1,4,8,16,32]
    block_sizes = [12,256,512,2048]
    trace_elements = 1000
    for files in mo_files:
        for block_size in block_sizes:
            for ways in wayss:
                print(files, cacheSize, ways, block_size)
                if (cacheSize//block_size//ways==0):
                    continue
